...
function hideUnneededContent(container, blocks, lefts, rights, hoverOver){
  ...
  hoverOver ? setTimeout(function() { changeDisplayToFlex(container, blocks, lefts, rights)}, 10) :
  globalTimeout = setTimeout(function() { makeContentTransparent(container, blocks, lefts, rights)}, 10)
}
...
function growItemBoxes(container, blocks, lefts, rights){
  ...
  globalTimeout = setTimeout(function() { makeContentOpaque(container) }, 100)
}
...
function makeContentTransparent(container, blocks, lefts, rights){
  ...
  globalTimeout = setTimeout(function() { shrinkItemBoxes(container, blocks, lefts, rights) }, 100)
}
...
function shrinkItemBoxes(container, blocks, lefts, rights){
  ...
  globalTimeout = setTimeout(function() { changeDisplayToNone(container) }, 300)
}
